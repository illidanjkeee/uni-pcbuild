...
const CLOUDINARY_UPLOAD_PRESET = "custom_computers_preset";
const CLOUDINARY_CLOUD_NAME = "gamma1199";
    ...
    <>
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        {addedPhotos.length < maxPhotos && (
          <label
            className={`h-32 cursor-pointer flex min-w-[130px] items-center gap-1 justify-center border bg-transparent rounded-2xl p-2 text-lg text-gray-600 ${
